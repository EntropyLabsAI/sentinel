...
const HumanReviews: React.FC<ReviewSectionProps> = ({
  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container flex">
          ...
          <div className="w-full md:w-1/4 pr-4">
            ...
            {humanReviewDataList.length === 0 ? (
              <p className="text-gray-500">No review requests at the moment. Check out the <a href="https://docs.sentinel.ai" className="text-blue-500">documentation</a> to see how to route your agent requests to the Human Review interface.</p>
            ) : (
      ...
      {/* HubStatsAccordion aligned at the bottom */}
