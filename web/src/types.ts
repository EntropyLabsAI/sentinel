...
export type AsteroidChoiceFinishReason = typeof AsteroidChoiceFinishReason[keyof typeof AsteroidChoiceFinishReason];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AsteroidChoiceFinishReason = {
  stop: 'stop',
  length: 'length',
...
export interface AsteroidChoice {
  asteroid_id: string;
  finish_reason: AsteroidChoiceFinishReason;
  index: number;
  message: AsteroidMessage;
}

export interface AsteroidToolCall {
...
export type AsteroidMessageRole = typeof AsteroidMessageRole[keyof typeof AsteroidMessageRole];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AsteroidMessageRole = {
  system: 'system',
  user: 'user',
  assistant: 'assistant',
  function: 'function',
...
export interface AsteroidMessage {
  content: string;
  created_at?: string;
...
export const getToolCall = (
 ...
 ): Promise<AxiosResponse<AsteroidToolCall>> => {
...
export const createNewChat = (
    runId: string,
    asteroidChat: AsteroidChat, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<ChatIds>> => {
    
    return axios.post(
      `/run/${runId}/chat`,
      asteroidChat,options
    );
  }
...
export const getCreateNewChatMutationOptions = <TError = AxiosError<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createNewChat>>, TError,{runId: string;data: AsteroidChat}, TContext>, axios?: AxiosRequestConfig}
): UseMutationOptions<Awaited<ReturnType<typeof createNewChat>>, TError,{runId: string;data: AsteroidChat}, TContext> => {
const {mutation: mutationOptions, axios: axiosOptions} = options ?? {};

      


      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createNewChat>>, {runId: string;data: AsteroidChat}> = (props) => {
          const {runId,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateNewChatMutationBody = AsteroidChat
...
export const useCreateNewChat = <TError = AxiosError<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createNewChat>>, TError,{runId: string;data: AsteroidChat}, TContext>, axios?: AxiosRequestConfig}
        ...
        TError,
        {runId: string;data: AsteroidChat},
        TContext
      > => {
